...
from transformers.models.bert.modeling_bert import ( BertForSequenceClassification,
    ...
    BertPreTrainedModel, BertLayer, BertModel, BertOutput,
...
class CoFiBertForSequenceClassification(BertPreTrainedModel):
...
class CoFiTeacherBertForSequenceClassification(BertForSequenceClassification):
    def __init__(self, config):
        super().__init__(config)
        self.bert = CoFiBertModel(config)
